...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://api.models.mint.isi.edu/v1.1.0"
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.models.mint.isi.edu/v1.1.0",
                'description': "No description provided",
            },
            {
                'url': "https://dev.api.models.mint.isi.edu/v1.1.0",
                'description': "No description provided",
            },
            {
                'url': "http://localhost:8080/v1.1.0",
                'description': "No description provided",
            }
        ]
