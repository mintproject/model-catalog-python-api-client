...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://api.models.mint.isi.edu/v1.3.1"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("modelcatalog")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: 2.0.0.dev1".\
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.models.mint.isi.edu/v1.3.1",
                'description': "No description provided",
            },
            {
                'url': "https://dev.api.models.mint.isi.edu/v1.3.1",
                'description': "No description provided",
            },
            {
                'url': "http://localhost:8080/v1.3.1",
                'description': "No description provided",
            }
        ]
