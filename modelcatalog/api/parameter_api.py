...
class ParameterApi(object):
    ...
    def parameters_id_delete(self, id, user, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.parameters_id_delete_with_http_info(id, user, **kwargs)  # noqa: E501
            return data
    ...
    def parameters_id_get(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.parameters_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def parameters_id_put(self, id, user, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.parameters_id_put_with_http_info(id, user, **kwargs)  # noqa: E501
            return data
    ...
    def parameters_post(self, user, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str user: Username (required)
        :param Parameter parameter: A new Parameterto be created
        :return: Parameter
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.parameters_post_with_http_info(user, **kwargs)  # noqa: E501
            return data
