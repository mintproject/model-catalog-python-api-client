...
class ParameterApi(object):
    ...
    def parameters_id_delete(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.parameters_id_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.parameters_id_delete_with_http_info(id, **kwargs)  # noqa: E501

    def parameters_id_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete an existing Parameter  # noqa: E501

        Delete an existing Parameter (more information in https://w3id.org/okn/o/sd#Parameter)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.parameters_id_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def parameters_id_put(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.parameters_id_put(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.parameters_id_put_with_http_info(id, **kwargs)  # noqa: E501

    def parameters_id_put_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update an existing Parameter  # noqa: E501

        Updates an existing Parameter (more information in https://w3id.org/okn/o/sd#Parameter)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.parameters_id_put_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def parameters_post(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.parameters_post(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.parameters_post_with_http_info(**kwargs)  # noqa: E501

    def parameters_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create one Parameter  # noqa: E501

        Create a new instance of Parameter (more information in https://w3id.org/okn/o/sd#Parameter)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.parameters_post_with_http_info(async_req=True)
        >>> result = thread.get()
