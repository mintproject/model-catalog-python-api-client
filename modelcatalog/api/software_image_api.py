...
class SoftwareImageApi(object):
    ...
    def softwareimages_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[SoftwareImage], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if 'per_page' in local_var_params and local_var_params['per_page'] > 200:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `softwareimages_get`, must be a value less than or equal to `200`")  # noqa: E501
        if 'per_page' in local_var_params and local_var_params['per_page'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `softwareimages_get`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def softwareimages_id_delete(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.softwareimages_id_delete(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: The ID of the SoftwareImage to be retrieved (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.softwareimages_id_delete_with_http_info(id, **kwargs)  # noqa: E501

    def softwareimages_id_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete an existing SoftwareImage  # noqa: E501

        Delete an existing SoftwareImage (more information in https://w3id.org/okn/o/sd#SoftwareImage)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.softwareimages_id_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def softwareimages_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(SoftwareImage, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def softwareimages_id_put(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.softwareimages_id_put(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.softwareimages_id_put_with_http_info(id, **kwargs)  # noqa: E501

    def softwareimages_id_put_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update an existing SoftwareImage  # noqa: E501

        Updates an existing SoftwareImage (more information in https://w3id.org/okn/o/sd#SoftwareImage)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.softwareimages_id_put_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def softwareimages_post(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.softwareimages_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str user: Username
        :param SoftwareImage software_image: Information about the SoftwareImageto be created
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.softwareimages_post_with_http_info(**kwargs)  # noqa: E501

    def softwareimages_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create one SoftwareImage  # noqa: E501

        Create a new instance of SoftwareImage (more information in https://w3id.org/okn/o/sd#SoftwareImage)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.softwareimages_post_with_http_info(async_req=True)
        >>> result = thread.get()
