...
class TheoryGuidedModelApi(object):
    ...
    def theory_guidedmodels_id_delete(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.theory_guidedmodels_id_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.theory_guidedmodels_id_delete_with_http_info(id, **kwargs)  # noqa: E501

    def theory_guidedmodels_id_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete an existing Theory-GuidedModel  # noqa: E501

        Delete an existing Theory-GuidedModel (more information in https://w3id.org/okn/o/sdm#Theory-GuidedModel)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.theory_guidedmodels_id_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def theory_guidedmodels_id_put(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.theory_guidedmodels_id_put(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.theory_guidedmodels_id_put_with_http_info(id, **kwargs)  # noqa: E501

    def theory_guidedmodels_id_put_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update an existing Theory-GuidedModel  # noqa: E501

        Updates an existing Theory-GuidedModel (more information in https://w3id.org/okn/o/sdm#Theory-GuidedModel)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.theory_guidedmodels_id_put_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def theory_guidedmodels_post(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.theory_guidedmodels_post(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.theory_guidedmodels_post_with_http_info(**kwargs)  # noqa: E501

    def theory_guidedmodels_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create one Theory-GuidedModel  # noqa: E501

        Create a new instance of Theory-GuidedModel (more information in https://w3id.org/okn/o/sdm#Theory-GuidedModel)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.theory_guidedmodels_post_with_http_info(async_req=True)
        >>> result = thread.get()
