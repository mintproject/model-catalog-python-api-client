...
class OrganizationApi(object):
    ...
    def organizations_id_delete(self, id, user, **kwargs):  # noqa: E501
        """Delete a Organization  # noqa: E501

        Delete an existing Organization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.organizations_id_delete(id, user, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.organizations_id_delete_with_http_info(id, user, **kwargs)  # noqa: E501
        else:
            (data) = self.organizations_id_delete_with_http_info(id, user, **kwargs)  # noqa: E501
            return data

    def organizations_id_delete_with_http_info(self, id, user, **kwargs):  # noqa: E501
        """Delete a Organization  # noqa: E501

        Delete an existing Organization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.organizations_id_delete_with_http_info(id, user, async_req=True)
        >>> result = thread.get()
        ...
        if ('user' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `user` when calling `organizations_id_delete`")  # noqa: E501
    ...
    def organizations_id_put(self, id, user, **kwargs):  # noqa: E501
        """Update a Organization  # noqa: E501

        Updates an existing Organization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.organizations_id_put(id, user, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.organizations_id_put_with_http_info(id, user, **kwargs)  # noqa: E501
        else:
            (data) = self.organizations_id_put_with_http_info(id, user, **kwargs)  # noqa: E501
            return data

    def organizations_id_put_with_http_info(self, id, user, **kwargs):  # noqa: E501
        """Update a Organization  # noqa: E501

        Updates an existing Organization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.organizations_id_put_with_http_info(id, user, async_req=True)
        >>> result = thread.get()
        ...
        if ('user' not in local_var_params or
                local_var_params['user'] is None):
            raise ApiValueError("Missing the required parameter `user` when calling `organizations_id_put`")  # noqa: E501
    ...
    def organizations_post(self, user, **kwargs):  # noqa: E501
        """Create a Organization  # noqa: E501

        Create a new instance of a Organization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.organizations_post(user, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str user: Username (required)
        :param Organization organization: A new Organizationto be created
        :return: Organization
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.organizations_post_with_http_info(user, **kwargs)  # noqa: E501
        else:
            (data) = self.organizations_post_with_http_info(user, **kwargs)  # noqa: E501
            return data

    def organizations_post_with_http_info(self, user, **kwargs):  # noqa: E501
        """Create a Organization  # noqa: E501

        Create a new instance of a Organization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.organizations_post_with_http_info(user, async_req=True)
        >>> result = thread.get()
        ...
        if ('user' not in local_var_params or
                local_var_params['user'] is None):
            raise ApiValueError("Missing the required parameter `user` when calling `organizations_post`")  # noqa: E501
