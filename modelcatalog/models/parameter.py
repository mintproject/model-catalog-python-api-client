...
class Parameter(object):
    ...
    def __init__(self, has_default_value=None, has_maximum_accepted_value=None, description=None, has_data_type=None, has_fixed_value=None, has_presentation=None, label=None, recommended_increment=None, type=None, has_minimum_accepted_value=None, has_accepted_values=None, adjusts_variable=None, relevant_for_intervention=None, position=None, id=None, uses_unit=None, has_step_size=None):  # noqa: E501
        ...
        if recommended_increment is not None:
            self.recommended_increment = recommended_increment
        else:
            if hasattr(self, '_recommended_increment'): del self._recommended_increment
            if hasattr(self.attribute_map, 'recommended_increment'): del self.attribute_map['recommended_increment']
            if hasattr(self.openapi_types, 'recommended_increment'): del self.openapi_types['recommended_increment']
        if type is not None:
            self.type = type
        else:
        ...
        if relevant_for_intervention is not None:
            self.relevant_for_intervention = relevant_for_intervention
        else:
            if hasattr(self, '_relevant_for_intervention'): del self._relevant_for_intervention
            if hasattr(self.attribute_map, 'relevant_for_intervention'): del self.attribute_map['relevant_for_intervention']
            if hasattr(self.openapi_types, 'relevant_for_intervention'): del self.openapi_types['relevant_for_intervention']
