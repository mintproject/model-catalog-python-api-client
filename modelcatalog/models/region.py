...
class Region(object):
    ...
    def __init__(self, geo=None, description=None, country=None, id=None, label=None, type=None):  # noqa: E501
        ...
        if country is not None:
            ...
            if hasattr(self, '_country'): del self._country
            if hasattr(self.attribute_map, 'country'): del self.attribute_map['country']
            if hasattr(self.openapi_types, 'country'): del self.openapi_types['country']
        if id is not None:
            self.id = id
