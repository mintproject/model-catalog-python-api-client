# mint_client.TheoryGuidedModelApi
...
> list[TheoryGuidedModel] theory_guidedmodels_get(username=username)
...
api_instance = mint_client.TheoryGuidedModelApi()
username = 'username_example' # str | Username to query (optional)

try:
    # List all Theory-GuidedModel entities
    api_response = api_instance.theory_guidedmodels_get(username=username)
    pprint(api_response)
...
# create an instance of the API class
api_instance = mint_client.TheoryGuidedModelApi(mint_client.ApiClient(configuration))
...
id = 'id_example' # str | The ID of the resource
user = 'user_example' # str | Username
theory_guided_model = mint_client.TheoryGuidedModel() # TheoryGuidedModel | An old Theory-GuidedModelto be updated (optional)
...
api_instance = mint_client.TheoryGuidedModelApi(mint_client.ApiClient(configuration))
user = 'user_example' # str | Username
theory_guided_model = mint_client.TheoryGuidedModel() # TheoryGuidedModel | A new Theory-GuidedModelto be created (optional)
