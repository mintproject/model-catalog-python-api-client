...
# **sampleresources_get**
> list[SampleResource] sampleresources_get(username=username)
...
api_instance = mint_client.SampleResourceApi()
...
# create an instance of the API class
api_instance = mint_client.SampleResourceApi(mint_client.ApiClient(configuration))
...
> sampleresources_id_put(id, user, sample_resource=sample_resource)
...
id = 'id_example' # str | The ID of the resource
user = 'user_example' # str | Username
sample_resource = mint_client.SampleResource() # SampleResource | An old SampleResourceto be updated (optional)

try:
    # Update a SampleResource
    api_instance.sampleresources_id_put(id, user, sample_resource=sample_resource)
except ApiException as e:
...
> sampleresources_post(user, sample_resource=sample_resource)
...
api_instance = mint_client.SampleResourceApi(mint_client.ApiClient(configuration))
user = 'user_example' # str | Username
sample_resource = mint_client.SampleResource() # SampleResource | A new SampleResourceto be created (optional)

try:
    # Create a SampleResource
    api_instance.sampleresources_post(user, sample_resource=sample_resource)
except ApiException as e:
