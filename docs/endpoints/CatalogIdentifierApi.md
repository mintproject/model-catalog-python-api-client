...
> catalogidentifiers_id_delete(id, user)
...
try:
    # Delete an existing CatalogIdentifier
    api_instance.catalogidentifiers_id_delete(id, user)
except ApiException as e:
...
> CatalogIdentifier catalogidentifiers_id_put(id, user, catalog_identifier=catalog_identifier)
...
try:
    # Update an existing CatalogIdentifier
    api_response = api_instance.catalogidentifiers_id_put(id, user, catalog_identifier=catalog_identifier)
    pprint(api_response)
except ApiException as e:
...
> CatalogIdentifier catalogidentifiers_post(user, catalog_identifier=catalog_identifier)
...
try:
    # Create one CatalogIdentifier
    api_response = api_instance.catalogidentifiers_post(user, catalog_identifier=catalog_identifier)
    pprint(api_response)
except ApiException as e:
