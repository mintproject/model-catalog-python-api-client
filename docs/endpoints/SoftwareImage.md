...
**available_in_registry** | **list[str]** | Property that indicates in which registry the software image being described can be found. For example, https://hub.docker.com | [optional] 
