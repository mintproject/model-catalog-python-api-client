...
> coupledmodels_id_delete(id, user)
...
try:
    # Delete an existing CoupledModel
    api_instance.coupledmodels_id_delete(id, user)
except ApiException as e:
...
> CoupledModel coupledmodels_id_put(id, user, coupled_model=coupled_model)
...
try:
    # Update an existing CoupledModel
    api_response = api_instance.coupledmodels_id_put(id, user, coupled_model=coupled_model)
    pprint(api_response)
except ApiException as e:
...
# **coupledmodels_post**
> CoupledModel coupledmodels_post(user, coupled_model=coupled_model)
...
try:
    # Create one CoupledModel
    api_response = api_instance.coupledmodels_post(user, coupled_model=coupled_model)
    pprint(api_response)
except ApiException as e:
