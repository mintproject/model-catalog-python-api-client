...
api_instance = mint_client.SourceCodeApi()
...
# create an instance of the API class
api_instance = mint_client.SourceCodeApi(mint_client.ApiClient(configuration))
...
# **sourcecodes_id_put**
> sourcecodes_id_put(id, user, source_code=source_code)
...
id = 'id_example' # str | The ID of the resource
user = 'user_example' # str | Username
source_code = mint_client.SourceCode() # SourceCode | An old SourceCodeto be updated (optional)

try:
    # Update a SourceCode
    api_instance.sourcecodes_id_put(id, user, source_code=source_code)
except ApiException as e:
...
# **sourcecodes_post**
> sourcecodes_post(user, source_code=source_code)
...
api_instance = mint_client.SourceCodeApi(mint_client.ApiClient(configuration))
user = 'user_example' # str | Username
source_code = mint_client.SourceCode() # SourceCode | A new SourceCodeto be created (optional)

try:
    # Create a SourceCode
    api_instance.sourcecodes_post(user, source_code=source_code)
except ApiException as e:
