...
api_instance = mint_client.GeoCoordinatesApi()
...
# create an instance of the API class
api_instance = mint_client.GeoCoordinatesApi(mint_client.ApiClient(configuration))
...
id = 'id_example' # str | The ID of the resource
user = 'user_example' # str | Username
geo_coordinates = mint_client.GeoCoordinates() # GeoCoordinates | An old GeoCoordinatesto be updated (optional)
...
api_instance = mint_client.GeoCoordinatesApi(mint_client.ApiClient(configuration))
user = 'user_example' # str | Username
geo_coordinates = mint_client.GeoCoordinates() # GeoCoordinates | A new GeoCoordinatesto be created (optional)
