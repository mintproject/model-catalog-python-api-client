...
# **softwareimages_get**
> list[SoftwareImage] softwareimages_get(username=username)
...
api_instance = mint_client.SoftwareImageApi()
username = 'username_example' # str | Username to query (optional)

try:
    # List all SoftwareImage entities
    api_response = api_instance.softwareimages_get(username=username)
    pprint(api_response)
...
# create an instance of the API class
api_instance = mint_client.SoftwareImageApi(mint_client.ApiClient(configuration))
...
> softwareimages_id_put(id, user, software_image=software_image)
...
id = 'id_example' # str | The ID of the resource
user = 'user_example' # str | Username
software_image = mint_client.SoftwareImage() # SoftwareImage | An old SoftwareImageto be updated (optional)

try:
    # Update a SoftwareImage
    api_instance.softwareimages_id_put(id, user, software_image=software_image)
except ApiException as e:
...
# **softwareimages_post**
> softwareimages_post(user, software_image=software_image)
...
api_instance = mint_client.SoftwareImageApi(mint_client.ApiClient(configuration))
user = 'user_example' # str | Username
software_image = mint_client.SoftwareImage() # SoftwareImage | A new SoftwareImageto be created (optional)

try:
    # Create a SoftwareImage
    api_instance.softwareimages_post(user, software_image=software_image)
except ApiException as e:
