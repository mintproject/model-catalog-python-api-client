...
# **causaldiagrams_get**
> list[CausalDiagram] causaldiagrams_get(username=username)
...
api_instance = mint_client.CausalDiagramApi()
...
id = 'id_example' # str | The ID of the resource
user = 'user_example' # str | Username
causal_diagram = mint_client.CausalDiagram() # CausalDiagram | An old CausalDiagramto be updated (optional)
...
api_instance = mint_client.CausalDiagramApi(mint_client.ApiClient(configuration))
user = 'user_example' # str | Username
causal_diagram = mint_client.CausalDiagram() # CausalDiagram | A new CausalDiagramto be created (optional)
