...
class DatasetSpecification(object):
    ...
    def __init__(self, label=None, has_format=None, description=None, has_dimensionality=None, has_presentation=None, type=None, id=None):  # noqa: E501
        ...
        if has_format is not None:
            ...
            if hasattr(self, has_format): del self._has_format
            if hasattr(self, self.attribute_map['has_format']): del self.attribute_map['has_format']
            if hasattr(self, self.openapi_types['has_format']): del self.openapi_types['has_format']
        ...
        if has_dimensionality is not None:
            ...
            if hasattr(self, has_dimensionality): del self._has_dimensionality
            if hasattr(self, self.attribute_map['has_dimensionality']): del self.attribute_map['has_dimensionality']
            if hasattr(self, self.openapi_types['has_dimensionality']): del self.openapi_types['has_dimensionality']
        if has_presentation is not None:
            self.has_presentation = has_presentation
        else:
            if hasattr(self, has_presentation): del self._has_presentation
            if hasattr(self, self.attribute_map['has_presentation']): del self.attribute_map['has_presentation']
            if hasattr(self, self.openapi_types['has_presentation']): del self.openapi_types['has_presentation']
        if type is not None:
            self.type = type
        else:
