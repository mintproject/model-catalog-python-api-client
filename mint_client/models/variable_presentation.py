...
class VariablePresentation(object):
    ...
    def __init__(self, id=None, type=None, label=None, description=None, has_long_name=None, has_short_name=None, has_standard_variable=None, has_relevance_level=None, uses_unit=None):  # noqa: E501
        ...
        if has_long_name is not None:
            ...
            if hasattr(self, has_long_name): del self._has_long_name
            if hasattr(self, self.attribute_map['has_long_name']): del self.attribute_map['has_long_name']
            if hasattr(self, self.openapi_types['has_long_name']): del self.openapi_types['has_long_name']
        if has_short_name is not None:
            self.has_short_name = has_short_name
        else:
            if hasattr(self, has_short_name): del self._has_short_name
            if hasattr(self, self.attribute_map['has_short_name']): del self.attribute_map['has_short_name']
            if hasattr(self, self.openapi_types['has_short_name']): del self.openapi_types['has_short_name']
        if has_standard_variable is not None:
            self.has_standard_variable = has_standard_variable
        else:
            if hasattr(self, has_standard_variable): del self._has_standard_variable
            if hasattr(self, self.attribute_map['has_standard_variable']): del self.attribute_map['has_standard_variable']
            if hasattr(self, self.openapi_types['has_standard_variable']): del self.openapi_types['has_standard_variable']
        if has_relevance_level is not None:
            self.has_relevance_level = has_relevance_level
        else:
            if hasattr(self, has_relevance_level): del self._has_relevance_level
            if hasattr(self, self.attribute_map['has_relevance_level']): del self.attribute_map['has_relevance_level']
            if hasattr(self, self.openapi_types['has_relevance_level']): del self.openapi_types['has_relevance_level']
